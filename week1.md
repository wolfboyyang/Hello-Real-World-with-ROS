...
**Step 2**: In a new terminal, start the sensor info publisher we developed in the videos.

```sh
rosrun hrwros_week1 sensor_info_publisher.py
```

**Step 3**: In a new terminal, run the week1_assignment1_part1.py script with

```
rosrun hrwros_week1_assignment week1_assignment1_part1.py
```
...
```sh
rosmsg show hrwros_week1_assignment/BoxHeightInformation
```
...
**Step 3**: In a new terminal, run the week1_assignment1_part3.py script with

```sh
rosrun hrwros_week1_assignment week1_assignment1_part3.py
```
...
If you did not close the terminals after completing assignment 1, you will have 3 programs running:

1. roscore
2. sensor_info_publisher.py
3. week1_assignment1_part3.py (ROS node for publishing and subscribing)
...
```sh
rosrun hrwros_week1_assignment week1_assignment2.py
```
...
```sh
roslaunch hrwros_week1_assignment hrwros_week1_assignments1_2.launch
```
